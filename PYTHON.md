> **Note:** This documents the original **Python** package, which is kept in this
> repository as the reference implementation and as the generator for the
> byte-exact golden test fixtures used by the TypeScript/WebUSB library.
> If you are looking for the browser library — printing from a web app via
> WebUSB — see [README.md](./README.md) instead.
